	...
	public void WifiConnect(String rawssid){
		...
		Runnable wifiStateCheckRunner = new Runnable(){
			public void run(){
				...
				intent.putExtra(Constant.BroadcastReceive.CONMUNICATION_SETUP_EXTRA_STATE, "wifi������֤��ʱ");
		...
		Runnable setupConnectionRunner = new Runnable(){
			public void run(){
				...
				if(!openSocketConnection()){
					WifiDisconnectCompletely();
					intent.putExtra(Constant.BroadcastReceive.CONMUNICATION_SETUP_EXTRA_STATE, "�Ѿ����˽��������������");
					sendBroadcast(intent);
					return;
				}
				...
				if(!getAdvertisement()){
					WifiDisconnectCompletely();
					intent.putExtra(Constant.BroadcastReceive.CONMUNICATION_SETUP_EXTRA_STATE, "�����߹رյ�3G�������ټ���");
					sendBroadcast(intent);
					return;
				}
				...
				if(!setHeartBeat()){
					WifiDisconnectCompletely();
					intent.putExtra(Constant.BroadcastReceive.CONMUNICATION_SETUP_EXTRA_STATE, "�������ж�");
					sendBroadcast(intent);
					return;
				}
