...
public class MainActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
    	...
    	tabHost.setup();
    	addTab("使用", R.drawable.tab_search_selector, R.id.receive, tabHost);
    	addTab("分享", R.drawable.tab_share_selector, R.id.send, tabHost);
    	addTab("其他", R.drawable.tab_settings_selector, R.id.other, tabHost);
